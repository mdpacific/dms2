...
let sensorReadings = [[26.1, 55.2]]; // example readings temperature 23.5, humidity 45.2
...
let farmerNote = "Inspected crops today. Noticed some yellowing leaves.";

//Number: GPS coordinates(latitude, longitude)
let gpsCoordinates = [[40.7128, -81.5462]];
